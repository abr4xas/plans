    ...
    public function chargeForLastDueSubscription($callback = null)
    {
        ...
        if (! is_callable($callback)) {
            try {
                ...
                event(new \Abr4xas\Plans\Events\Stripe\DueSubscriptionChargeSuccess($this, $lastDueSubscription, $stripeCharge));
            } catch (\Exception $exception) {
                event(new \Abr4xas\Plans\Events\Stripe\DueSubscriptionChargeFailed($this, $lastDueSubscription, $exception));
