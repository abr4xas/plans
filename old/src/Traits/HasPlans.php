...
trait HasPlans
{
    ...
    public function upgradeCurrentPlanTo($newPlan, int $duration = 30, bool $startFromNow = true, bool $isRecurring = true)
    {
        ...
        event(new \Abr4xas\Plans\Events\UpgradeSubscription($this, $subscription, $startFromNow, $oldPlan, $newPlan));
    ...
    public function upgradeCurrentPlanToUntil($newPlan, $date, bool $startFromNow = true, bool $isRecurring = true)
    {
        ...
        event(new \Abr4xas\Plans\Events\UpgradeSubscriptionUntil($this, $subscription, $date, $startFromNow, $oldPlan, $newPlan));
    ...
    public function extendCurrentSubscriptionWith(int $duration = 30, bool $startFromNow = true, bool $isRecurring = true)
    {
        ...
        if ($startFromNow) {
            ...
            event(new \Abr4xas\Plans\Events\ExtendSubscription($this, $activeSubscription, $startFromNow, null));
        ...
        event(new \Abr4xas\Plans\Events\ExtendSubscription($this, $activeSubscription, $startFromNow, $subscription));
    ...
    public function extendCurrentSubscriptionUntil($date, bool $startFromNow = true, bool $isRecurring = true)
    {
        ...
        if ($startFromNow) {
            ...
            event(new \Abr4xas\Plans\Events\ExtendSubscriptionUntil($this, $activeSubscription, $date, $startFromNow, null));
        ...
        event(new \Abr4xas\Plans\Events\ExtendSubscriptionUntil($this, $activeSubscription, $date, $startFromNow, $subscription));
    ...
    public function cancelCurrentSubscription()
    {
        ...
        event(new \Abr4xas\Plans\Events\CancelSubscription($this, $activeSubscription));
